...
export const DesktopApp = ({ typist }: DesktopAppProps) => {
  ...
  return (
    <div
      className={`h-screen overflow-hidden grid transition-[grid-template-columns] duration-200 ${controller.isSidebarCollapsed ? "grid-cols-[56px_minmax(0,1fr)]" : "grid-cols-[280px_minmax(0,1fr)]"
        }`}
    >
      <Sidebar
...
<MarkdownEditor
  ...
  editorShortcuts={controller.settings?.shortcuts ?? null}
/>
      </main>
      <CommandPalette
