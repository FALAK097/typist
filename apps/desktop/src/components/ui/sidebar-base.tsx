    ...
    return (
      <button
        ...
        className={cn(
          ...
          showOnHover && "opacity-0 group-hover/menu-item:pointer-events-auto group-hover/menu-item:opacity-100",
          className
        )}
        {...props}
      />
...
>(({ className, showIcon = false, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("relative flex h-8 w-full items-center gap-2 rounded-md bg-sidebar-accent px-2 py-1.5", className)}
    {...props}
  >
